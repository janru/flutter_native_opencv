...
typedef _create_rectified_image_func = ffi.Pointer<Utf8> Function(ffi.Pointer<Utf8>, ffi.Pointer<Utf8>);

// Dart function signatures
typedef _VersionFunc = ffi.Pointer<Utf8> Function();
typedef _ProcessImageFunc = void Function(ffi.Pointer<Utf8>, ffi.Pointer<Utf8>);
typedef _CreateRectifiedImageFunc = ffi.Pointer<Utf8> Function(ffi.Pointer<Utf8>, ffi.Pointer<Utf8>);
...
final _ProcessImageFunc _processImage = _lib
  ...
  .asFunction();
final _CreateRectifiedImageFunc _createRectifiedImage = _lib
    .lookup<ffi.NativeFunction<_create_rectified_image_func>>('create_rectified_image')
    .asFunction();
...
String createRectifiedImage(ProcessImageArguments args) {
  return Utf8.fromUtf8(_createRectifiedImage(Utf8.toUtf8(args.inputPath), Utf8.toUtf8(args.outputPath)));
}
